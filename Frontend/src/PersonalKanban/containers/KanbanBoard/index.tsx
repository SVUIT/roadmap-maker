  ...
  const handleColumnEdit = React.useCallback(
    ({ column }: { column: Column }) => {
      setColumns((_columns: Column[]) => {
        ...
        columns[columnIndex].dropdownOptionSubject = column.dropdownOptionSubject;
        ...
        columns[columnIndex].records = [
          {
            id: getId(),
            title: record.title,
            dropdownOptionSubject: record.dropdownOptionSubject,
  ...
  const handleRecordEdit = React.useCallback(
    ({ column, record }: { column: Column; record: Record }) => {
      ...
      setColumns((_columns) => {
        ...
        _record.dropdownOptionSubject = record.dropdownOptionSubject;
